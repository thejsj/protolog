...
module.exports = function (opts, self) {
  ...
  protoLog.color = function (obj, color) {
    console.log('color', obj, (obj instanceof FutureLog));
    if (!(obj instanceof FutureLog)) obj = new FutureLog(obj);
    obj.setString(
      __self.getColor('text', color) + obj.getValue() + colorCodes.reset
    );
    return obj;
  };
  ...
  protoLog.bold = function (obj, color) {
    if (!(obj instanceof FutureLog)) obj = new FutureLog(obj);
    obj.setString(
      __self.getColor('bold', color) + obj.getValue() + colorCodes.reset
    );
    return obj;
  };
  ...
  protoLog.underline = function (obj, color) {
    if (!(obj instanceof FutureLog)) obj = new FutureLog(obj);
    obj.setString(
      __self.getColor('underline', color) + obj.getValue() + colorCodes.reset
    );
    return obj;
  };

  protoLog.background = function (obj, color) {
    console.log('background', obj, (obj instanceof FutureLog));
    console.log(obj.getString());
    if (!(obj instanceof FutureLog)) obj = new FutureLog(obj);
    obj.setString(
      __self.getColor('background', color) + obj.getString() + colorCodes.reset
    );
    console.log(obj.getString());
    return obj;
  };
